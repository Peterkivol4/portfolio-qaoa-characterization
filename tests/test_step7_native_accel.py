...
from layerfield_qaoa.objective import weighted_cvar
from layerfield_qaoa.reporting import _bootstrap_ci


def test_weighted_cvar_python_path(monkeypatch):
    monkeypatch.delenv("LAYERFIELD_QAOA_NATIVE", raising=False)
    monkeypatch.setenv("LAYERFIELD_QAOA_NATIVE_DISABLE", "1")
...
def test_native_weighted_cvar_matches_python(monkeypatch):
    ...
    monkeypatch.delenv("LAYERFIELD_QAOA_NATIVE_DISABLE", raising=False)
    monkeypatch.setenv("LAYERFIELD_QAOA_NATIVE", "1")
